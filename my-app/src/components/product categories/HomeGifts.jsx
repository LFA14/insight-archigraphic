...
// Functional Component: HomeGifts
// Purpose: Displays products related to Home & Gifts category
const HomeGifts = () => {
    ...
    // Function to fetch products from the server based on the Home & Gifts category
    const fetchProducts = async () => {
        try {
            // Fetching products via the service
            const data = await fetchProductsByCategory("Home and Gifts");
    ...
    return (
        <div className="container mt-4">
            {/* Page Title */}
            <h2 className="text-center">Home & Gifts</h2>
            <div className="row">
...
// Exporting the HomeGifts component as default for use in routing or rendering elsewhere
