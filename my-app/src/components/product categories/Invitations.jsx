...
// Functional Component: Invitations
// Purpose: Displays products related to Invitations & Wedding Cards category
const Invitations = () => {
    ...
    // Function to fetch products from the server based on the Invitations & Wedding Cards category
    const fetchProducts = async () => {
        try {
            // Fetching products via the service
            const data = await fetchProductsByCategory("Invitations and Wedding Cards");
    ...
    return (
        <div className="container mt-4">
            {/* Page Title */}
            <h2 className="text-center">Invitations & Wedding Cards</h2>
            <div className="row">
...
// Exporting the Invitations component as default for use in routing or rendering elsewhere
